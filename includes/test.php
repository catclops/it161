...
<body>
	...
	<?php
        ...
        $toAddress = "catclops88@gmail.com";  //place your/your client's email address here
        $toName = "Toan Nguyen"; //place your client's name here
        $website = "Tone Trading";  //place NAME of your client's website
